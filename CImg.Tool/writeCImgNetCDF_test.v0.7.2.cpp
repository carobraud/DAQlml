...
/*CImg test*/
  ...
  for(int t=0;t<nt;++t)
  {
    cimg_forXYZV(img,x,y,z,v) img(x,y,z,v)=t*x*y*z*v+x+y+z+v+t;
...
////data
  for(int t=0;t<nt;++t)
  {
    cimglist_for(imgList,l) cimg_forXYZV(imgList(l),x,y,z,v) imgList(l)(x,y,z,v)=t*x*y*z*v*l+x+y+z+v+t+l;
...
////data
//////t=0
  cimglist_for(imgList4D,l) cimg_forXYZV(imgList4D(l),x,y,z,v) imgList4D(l)(x,y,z,v)=x*y*z*v*l;
  cimg_forXYZV(img4D,x,y,z,v) img4D(x,y,z,v)=1;
...
//////t=1
  cimglist_for(imgList4D,l) cimg_forXYZV(imgList4D(l),x,y,z,v) imgList4D(l)(x,y,z,v)=(x*y*z*v+1)*(l+1);
  cimg_forXYZV(img4D,x,y,z,v) img4D(x,y,z,v)=0;
