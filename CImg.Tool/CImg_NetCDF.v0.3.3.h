...
//  int addNetCDFVar(CImg &img,std::string var_name,std::string unit_name,std::vector<std::string> dim_names,std::string time_name)
  template <typename t2>int addNetCDFVar(CImg<t2> &img,std::string var_name,std::string unit_name)
  {
#if cimg_debug>10
...
/*  template<typename T> T* ptr(void)
 ...
 template <typename t3> int addNetCDFData(CImg<t3> &img,int time=-1){
#if cimg_debug>10
